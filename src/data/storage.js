...
class Storage {
    ...
    async createSignedUrl(_remotePath, _method = 'GET', _expiresIn = 3600, _contentType = null) {
...
class FileSystemStorage extends Storage {
    ...
    async createSignedUrl(remotePath, _method = 'GET', _expiresIn = 3600, _contentType = null) {
...
export { S3Storage, MinioStorage, SeaweedStorage, FirebaseStorage, FileSystemStorage };

...
async function initFirebaseStorage() {
    ...
    if (typeof global !== "undefined" && global._vy_firebase_admin_sdk) {
        ...
        const { getStorage, ref, uploadString, getDownloadURL } =
            await import('./index.esm-CG3re3Nw.js');
...
class OrganizationsData {
    ...
    async ensurePersonalOrg(user) {
        ...
        console.log(
            "Ensuring personal organization for user:",
            userId,
            "with poid:",
            poid
        );
        const orgName = displayName ? `${displayName}'s Personal` : "Personal";
        this.tokenize(displayName || user.email);
        let existing = null;
        try {
            if (poid) {
        ...
        console.log("Existing personal organization:", existing);
        ...
        console.log("Creating new personal organization for user:", userId);
        const org = {
            name: orgName,
            isPersonal: true,
            uid: userId,
        ...
        await apiUtil.call("/api/org/sync", {}, "POST");
...
//# sourceMappingURL=index-Bl0GypHH.js.map

...
async function initFirebaseStorage() {
    ...
    if (typeof global !== "undefined" && global._vy_firebase_admin_sdk) {
        ...
        const { getStorage, ref, uploadString, getDownloadURL } =
            await import('./index.esm-CIA1QELV.js');
...
async function initializeFirestore() {
    ...
    serverTimestamp$1 = firebaseFunctions.serverTimestamp;
...
class Database {
    ...
    async set(collectionName, docData) {
        ...
        if (!docData.id) {
            ...
            docData.created = serverTimestamp$1();
        }

        docData.updated = serverTimestamp$1();
    ...
    async update(collectionName, docId, updates) {
        ...
        processedUpdates.updated = serverTimestamp$1();
...
//# sourceMappingURL=index-BO4Setiw.js.map

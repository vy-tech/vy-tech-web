...
class S3Storage extends Storage {
    ...
    async _ensureClient() {
        ...
        console.log(`Initializing S3 client for ${this.storageType} storage`);
        console.log(`S3 Client Options:`, this._s3ClientOptions);
    ...
    async createSignedUrl(
        ...
        console.log("Getting bucket and key");
...
async function initFirebaseStorage() {
    ...
    if (typeof global !== "undefined" && global._vy_firebase_admin_sdk) {
        ...
        const { getStorage, ref, uploadString, getDownloadURL } =
            await import('./index.esm-O4LPLAUo.js');
...
fileApp.post("/upload/:path", async (req, res) => {
    ...
    console.log(`Valid oids are [${validOids.join(", ")}]`);
    ...
    console.log(
        `Requested Org ID: ${requestedOrgId}    Mime Type: ${mimeType}  Storage Type: ${storageType}`
    );
    console.log(`Getting secrets for storage type: ${storageType}`);
...
//# sourceMappingURL=index-CdiXlub5.js.map

...
async function initFirebaseStorage() {
    ...
    if (typeof global !== "undefined" && global._vy_firebase_admin_sdk) {
        ...
        const { getStorage, ref, uploadString, getDownloadURL } =
            await import('./index.esm-DUpVnS9b.js');
...
class FilesData {
    ...
    async save(
        ...
        orgId = orgId || orgContext.getCurrentOrg();
        ...
        const fileDoc = {
            filename: filename,
            path: `${orgId}/${destinationPath}/${filename}`,
            context: context,
            type: type,
            oid: orgId,
...
//# sourceMappingURL=index-DbQtLiXB.js.map

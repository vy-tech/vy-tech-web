    ...
    constructor() {
        ...
        eventBus.on("playback.timeupdate", (e) => {
            ...
            if (this.summary && second in this.summary) {
                ...
                if (entry.people) this.current.people = entry.people;
                if (entry.adult) {
                    this.current.adult = entry.adult;

                    // Child detection is currently not populating correctly
                    if (this.current.people) {
                        this.current.child =
                            this.current.people - this.current.adult;
                    }
                }
...
//# sourceMappingURL=annotations-qwSRYGHy.js.map

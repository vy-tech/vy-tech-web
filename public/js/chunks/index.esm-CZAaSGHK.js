import { g as getApp, c as _getProvider, d as getDefaultEmulatorHostnameAndPort, b as getModularInstance, i as isCloudWorkstation, p as pingServer, u as updateEmulatorBanner, t as deepEqual, e as createMockUserToken, F as FirebaseError, L as Logger, n as LogLevel, J as isSafari, l as getUA, S as SDK_VERSION, _ as _registerComponent, C as Component, r as registerVersion, a as _isFirebaseServerApp } from './index.esm2017-C41EWvTK.js';
...
class Transaction$2 {
    ...
    async lookup(e) {
        if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw this.lastTransactionError = new FirestoreError(N.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes."), 
 ...
 */ class __PRIVATE_TransactionRunner {
    constructor(e, t, n, r, i) {
        ...
        this.deferred = i, this.Gu = n.maxAttempts, this.F_ = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */);
    }
    ...
    Hu(e) {
        this.Gu > 0 && this.Yu(e) ? (this.Gu -= 1, this.asyncQueue.enqueueAndForget((() => (this.ju(), 
...
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(e, t, n, r, i, s) {
    const o = e.Dc(1 /* UserDataSource.Update */ , t, n), _ = [ __PRIVATE_fieldPathFromArgument$1(t, r, n) ], a = [ i ];
...
export { AbstractUserDataWriter, Bytes, CollectionReference, DocumentReference, DocumentSnapshot, FieldPath, FieldValue, Firestore, FirestoreError, GeoPoint, Query, QueryCompositeFilterConstraint, QueryConstraint, QueryDocumentSnapshot, QueryFieldFilterConstraint, QueryOrderByConstraint, QuerySnapshot, SnapshotMetadata, Timestamp, Transaction, VectorValue, __PRIVATE_AutoId as _AutoId, ByteString as _ByteString, DatabaseId as _DatabaseId, DocumentKey as _DocumentKey, __PRIVATE_EmptyAuthCredentialsProvider as _EmptyAuthCredentialsProvider, FieldPath$1 as _FieldPath, __PRIVATE_cast as _cast, __PRIVATE_logWarn as _logWarn, __PRIVATE_validateIsNotUsedTogether as _validateIsNotUsedTogether, addDoc, collection, connectFirestoreEmulator, deleteDoc, doc, ensureFirestoreConfigured, executeWrite, getDoc, getDocs, getFirestore, onSnapshot, orderBy, query, runTransaction, serverTimestamp, setDoc, updateDoc, where };
//# sourceMappingURL=index.esm-CZAaSGHK.js.map

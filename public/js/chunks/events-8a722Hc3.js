...
class EventsData {
    ...
    async getByHierarchy(hierarchy) {
        ...
        // Backcompat with events that are location:date:01
        if (!h.org && !h.event && h.date) {
            h.camera = 1;
        }

        const events = await database.query("events", {
...
//# sourceMappingURL=events-8a722Hc3.js.map

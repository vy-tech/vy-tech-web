...
async function getApp$1() {
    ...
    if (typeof global !== "undefined" && global._vy_firebase_admin_sdk) {
        ...
        const { initializeApp } = await import('./index.esm-C55dWS3U.js');
...
async function initializeFirestore() {
    ...
    if (typeof global !== "undefined" && global._vy_firebase_admin_sdk) {
        ...
        const firebaseModules = await import('./index.esm-CsWoe6HX.js');
...
export { isSafari as A, isSafariOrWebkit as B, Component as C, initializeApp as D, DEFAULT_ENTRY_NAME as E, FirebaseError as F, GoogleAuthProvider as G, _addComponent as H, _apps as I, _components as J, _serverApps as K, Logger as L, __awaiter as M, __generator as N, OAuthProvider as O, __values as P, SDK_VERSION as S, _registerComponent as _, apiUtil as a, getAuth as b, signInWithPopup as c, database as d, signOut as e, fetchSignInMethodsForEmail as f, getApp$1 as g, serverTimestamp as h, _isFirebaseServerApp as i, LogLevel as j, getModularInstance as k, linkWithCredential as l, deepEqual as m, isCloudWorkstation as n, createMockUserToken as o, pingServer as p, getApp as q, registerVersion as r, signInWithEmailAndPassword as s, _getProvider as t, updateEmulatorBanner as u, getDefaultEmulatorHostnameAndPort as v, _removeServiceInstance as w, getGlobal as x, isIndexedDBAvailable as y, getUA as z };
//# sourceMappingURL=apiUtil-BPgA2fJq.js.map

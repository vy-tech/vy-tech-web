...
import { o as orgContext } from './orgContext-tclx_34J.js';
...
class Hierarchy {
    ...
    toFileString(separator = ":") {
        if (this.location && this.event) {
            return [this.location, this.date, this.event, this.file].join(
                separator
            );
        } else {
            return [this.org, this.file].join(separator);
        }
    }
    ...
    static test() {
        ...
        test("location/date", "MainStreet/20240101", {
            location: "MainStreet", date: 20240101,
            org: null, event: null, camera: null, file: null,
        });

        // $org/$file — length=2, both strings
        test("org/file", "AcmeCorp/game.mp4", {
            org: "AcmeCorp", file: "game.mp4",
            location: null, date: null, event: null, camera: null,
        });

        // $location/$date/$camera — length=3, ends with number
        test("location/date/camera", "MainStreet/20240101/2", {
            location: "MainStreet", date: 20240101, camera: 2,
            org: null, event: null, file: null,
        });

        // $org/$location/$date/$event — length=4, ends with string
        test("org/location/date/event", "AcmeCorp/MainStreet/20240101/Finals", {
            org: "AcmeCorp", location: "MainStreet", date: 20240101, event: "Finals",
            camera: null, file: null,
        });

        // $org/$location/$date/$camera — length=4, ends with number
        test("org/location/date/camera", "AcmeCorp/MainStreet/20240101/3", {
            org: "AcmeCorp", location: "MainStreet", date: 20240101, camera: 3,
            event: null, file: null,
        });

        // $org/$location/$date/$event/$camera — length=5, ends with number
        test("org/location/date/event/camera", "AcmeCorp/MainStreet/20240101/Finals/2", {
            org: "AcmeCorp", location: "MainStreet", date: 20240101, event: "Finals", camera: 2,
            file: null,
        });

        // $org/$location/$date/$event/$file — length=5, ends with string
        test("org/location/date/event/file", "AcmeCorp/MainStreet/20240101/Finals/clip.mp4", {
            org: "AcmeCorp", location: "MainStreet", date: 20240101, event: "Finals", file: "clip.mp4",
            camera: null,
        });

        // $key=$val/... — all parts contain equals
        test("key=val pairs", "org=AcmeCorp/location=MainStreet/date=20240101", {
...
//# sourceMappingURL=hierarchy-IbuUWY3l.js.map

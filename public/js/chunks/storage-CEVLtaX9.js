import { b as getAuth, g as getApp } from './apiUtil-BPgA2fJq.js';
...
async function loadAwsSdk() {
    ...
    try {
        const [s3, presigner] = await Promise.all([
            import('./index-Bc5rNDiZ.js').then(function (n) { return n.i; }),
            import('./index-BY95Z6Cp.js'),
        ]);
        _awsSdk = {
...
async function initFirebaseStorage() {
    ...
    if (typeof global !== "undefined" && global._vy_firebase_admin_sdk) {
        ...
        const { getStorage, ref, uploadString, getDownloadURL } =
            await import('./index.esm-CmWjFqrO.js');
...
//# sourceMappingURL=storage-CEVLtaX9.js.map

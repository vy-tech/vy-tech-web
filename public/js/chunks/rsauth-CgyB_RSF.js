...
import { d as database, g as getApp$1 } from './db-BZQDImdW.js';
import { e as eventBus } from './eventbus-B9JUr222.js';
import { L as Logger, g as getExperimentalSetting, i as isMobileCordova, a as isReactNative, _ as _registerComponent, C as Component, r as registerVersion, b as isBrowserExtension, S as SDK_VERSION, E as ErrorFactory, c as _isFirebaseServerApp, d as getModularInstance, e as getUA, f as createSubscribe, h as LogLevel, F as FirebaseError, j as base64Decode, q as querystring, k as isCloudWorkstation, l as getApp, m as _getProvider, n as getDefaultEmulatorHost, o as deepEqual, p as pingServer, u as updateEmulatorBanner, s as querystringDecode, t as extractQuerystring, v as isIE, w as isEmpty, x as isCloudflareWorker } from './index.esm2017-D8q59gHf.js';
...
const COLLECTION$1 = "userProfiles";
...
class UserProfilesData {
    ...
    async ensureProfile(id, email, displayName) {
        ...
        if (!profile) {
            ...
            await database.set(COLLECTION$1, newProfile);
    ...
    async update(id, updates) {
        ...
        if (Object.keys(filteredUpdates).length > 0) {
            await database.update(COLLECTION$1, id, filteredUpdates);
        }
    }
}
...
class OrganizationsData {
    ...
    async ensurePersonalOrg(userId) {
        const existing = await database.query(COLLECTION, {
            isPersonal: true,
            owners: { op: "array-contains", value: userId },
        });
...
class Auth {
    ...
    async init() {
        this.auth = getAuth(await getApp$1());
...
export { Auth as A, OrganizationsData as O, UserProfilesData as U, auth as a, getAuth as g };
//# sourceMappingURL=rsauth-CgyB_RSF.js.map

...
if (typeof global !== "undefined" && global._vy_firebase_admin_sdk) {
    // Admin SDK uses different API - functions are methods on firestore instance
    ...
    firebaseFunctions = {
        ...
        runTransaction: (database, updateFunction) => db.runTransaction(updateFunction),
    };
} else {
...
//# sourceMappingURL=db-CdhchuJp.js.map

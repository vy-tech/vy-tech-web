...
class EventsData {
    ...
    create(name, description, beginLocal, endLocal, locationId, timeZone="America/Los_Angeles") {

        const begin = timeUtil.asUTC(beginLocal, timeZone);
        const end = timeUtil.asUTC(endLocal, timeZone);
...
export { EventsData as E, eventsData as e, timeUtil as t };
//# sourceMappingURL=events-BLy60mki.js.map

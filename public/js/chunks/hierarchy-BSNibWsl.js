...
class Hierarchy {
    ...
    toCameraString(separator = ":", defaultCamera = 1) {
        ...
        return this.org && this.event
            ? [this.org, this.location, this.date, this.event, cam].join(
                  separator
              )
            : [this.location, this.date, cam].join(separator);
    }

    toEventString(separator = ":") {
        return this.org && this.event
            ? [this.org, this.location, this.date, this.event].join(separator)
            : [this.location, this.date].join(separator);
    }
}

export { EventsData as E, Hierarchy as H, eventsData as e, timeUtil as t };
//# sourceMappingURL=hierarchy-BSNibWsl.js.map

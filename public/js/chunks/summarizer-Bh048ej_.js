import { g as getApp, d as database } from './db-CGVhGgFt.js';
import { g as getAuth } from './index-35c79a8a-0GYTVUrZ.js';
import './index.esm2017-BazQTVFY.js';
import { S as Score, b as progress, a as activeBoxManager } from './annotations-DkwQ2RS9.js';
import { e as eventBus } from './eventbus-B9JUr222.js';
import { H as Hierarchy, e as eventsData } from './hierarchy-D6rWsq2G.js';
...
async function initFirebaseStorage() {
    ...
    if (typeof global !== "undefined" && global._vy_firebase_admin_sdk) {
        ...
        const { getStorage, ref, uploadString, getDownloadURL } =
            await import('./index.esm-Cp4E3tJb.js');
...
//# sourceMappingURL=summarizer-Bh048ej_.js.map
